  ...
  return (
    <div key={blog.id} className="w-full min-h-screen py-10">
      <div className=" max-w-200  mx-auto shadow-md hover:shadow-lg rounded-md bg-gray-200 flex flex-col">
        ...
        <div className="px-3 prose prose-lg max-w-none font-roboto-serif text-gray-800 leading-tight p-5 indent-8 first-letter:text-3xl first-letter:font-bold first-letter:text-blue-600 text-sm">
          {blog.details}
        </div>
